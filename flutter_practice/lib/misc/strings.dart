...
class Strings extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'en_US': {
          ...
          'systemErrorPleaseContactUs': 'System error occurred! Please contact us if this error persist',
          ...
          'weekPasswordError': 'Password must contain at least 1 uppercase, 1 lower case characters, 1 digit and be at least 8 characters long!',
          ...
          'userNotExistOrPasswordWrongError': 'User with this email does not exist or password is incorrect!',
          ...
          'textToSpeachConvertionNotAvailableError': 'Text to speach convertion is not available at this moment',
        },
      };
}